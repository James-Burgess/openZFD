var app = (function()
{
	...
	function onDeviceReady()
	{
		...
		let elem = $("<button>openZFD</button>")
		$('#beacon').append(elem);
		let myEl = document.getElementById('beacon');

		myEl.addEventListener('click', function() {sendOpenRequest()});
	...
	function sendOpenRequest(){
		xhr.onreadystatechange = function () {
		    ...
		    if (this.status == 200) {
		        ...
		        let region = mRegionEvents[mRegionEvents.length - 1].regionId
		        console.log(region)
		        console.log(mRegionData[region])
	...
	let url = 'https://hot-cobra-98.localtunnel.me/api/public?name=james'
